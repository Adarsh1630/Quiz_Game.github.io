let questions = [
    ...
    answer: "To declare a method that belongs to the class rather than an instance of the class",
    options: [
      "To indicate that a variable is constant",
      "To declare a method that belongs to the class rather than an instance of the class",
      "To specify that a class cannot be instantiated",
      "To define a variable that is shared among all instances of a class"
    ]
  },
    {
    numb: 2,
    question: " Which of the following Java Collection Framework interfaces extends the Collection interface and allows duplicate elements?",
    answer: "List",
    options: [
      "Set",
      "List",
    ...
    {
    numb: 4,
    question: "Which design pattern is used to define a family of algorithms, encapsulate each algorithm, and make them interchangeable?",
    answer: "Strategy",
    options: [
      "Observer",
      "Strategy",
    ...
    {
    numb: 5,
    question: "In Java, what is the purpose of the 'transient' keyword when applied to a variable?",
...
function startTimerLine(time){
    counterLine = setInterval(timer, 97);
    function timer(){
